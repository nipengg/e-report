                  ...
                  return (
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <ModalEdit
                          token={token}
                          setCheck={setCheck} setMsg={setMsg} setType={setType}
                          lecId={lecturer.lecturer_id}
                          lecName={lecturer.lecturer_name}
                          lecAge={lecturer.lecturer_age}
                          lecAddress={lecturer.lecturer_address}
                        />
                      </td>
                    </tr>
